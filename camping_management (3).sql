...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 25, 2025 at 07:05 PM
...
(28, 'Beja', 'tent', 10.00, 5, 1, 1, 'dgfhjklm', '../uploads/1744578869_1742644804792.jpg', '2025-04-13 21:14:29', '2025-04-13 21:14:29', 28),
(29, 'Zaghouen', 'tent', 0.25, 5, 1, 0, 'Hello', '../uploads/1745597651_Capture d\'̩cran 2025-03-02 001913.png', '2025-04-25 16:14:11', '2025-04-25 16:14:11', 28);
...
(2, 26, 'dsfvdf', 0.00),
(3, 26, 'dsf', 0.00),
(5, 28, 'kfklfdlklllll', 0.00),
(6, 28, 'dsfvdf', 0.00),
(7, 28, 'dsf', 0.00),
(8, 29, 'kfklfdlklllll', 0.00);
...
INSERT INTO `reservations` (`id`, `user_id`, `location_id`, `start_date`, `end_date`, `total_price`, `payment_method`, `status`, `created_at`) VALUES
(1, 29, 28, '2025-04-09', '2025-04-17', 14.00, '', 'confirmed', '2025-04-22 19:16:20'),
(2, 29, 19, '2025-04-24', '2025-04-25', 0.04, '', 'confirmed', '2025-04-22 20:00:02'),
(3, 29, 23, '2025-04-25', '2025-05-06', 352.00, '', 'confirmed', '2025-04-22 20:00:57'),
(4, 29, 19, '2025-04-24', '2025-05-02', 0.32, '', 'cancelled', '2025-04-22 20:06:50'),
(5, 32, 19, '2025-04-23', '2025-04-29', 0.24, '', 'confirmed', '2025-04-22 20:14:05'),
(6, 28, 21, '2025-04-24', '2025-04-26', 0.32, '', 'confirmed', '2025-04-22 20:20:46'),
(7, 29, 23, '2025-04-23', '2025-04-26', 96.00, '', 'confirmed', '2025-04-22 20:21:41'),
(8, 29, 19, '2025-04-26', '2025-04-30', 0.16, '', 'confirmed', '2025-04-25 15:19:58'),
(9, 32, 27, '2025-04-26', '2025-04-28', 466.00, '', 'cancelled', '2025-04-25 15:39:23'),
(10, 32, 24, '2025-04-26', '2025-04-30', 2092.00, '', 'confirmed', '2025-04-25 15:49:59'),
(11, 32, 19, '2025-04-26', '2025-04-28', 0.08, '', 'pending', '2025-04-25 15:52:23'),
(12, 32, 19, '2025-04-26', '2025-04-28', 0.08, '', 'pending', '2025-04-25 15:56:47'),
(13, 32, 19, '2025-04-26', '2025-04-28', 0.08, '', 'pending', '2025-04-25 16:03:52'),
(14, 29, 21, '2025-04-26', '2025-04-28', 0.32, '', 'confirmed', '2025-04-25 16:13:12');
...
(28, 'trabelsiwejden911@gmail.com', 'wejden', '$2y$10$EXdW3VSAYqXbhdwGnxcf6OOmn9K0bVejyZy6DN1PNDZfwtLG3Ng9O', 'admin', 'active', '2025-04-13 23:12:59', 0, 'female', 18),
(29, 'trabelsijihen23@gmail.com', 'jihen', '$2y$10$fWIEXbY7A1VN8wRjx3VzueiAv4UHUU.zlrJRcrF.DUFwSZ/aC6MV2', 'client', 'active', '2025-04-13 23:13:22', 0, 'female', 18),
(32, 'trabelsiwejden369@gmail.com', 'arije', '$2y$10$lDPZn0utV2UXBhXCnPjxXeyUrElwj80fluHg5Eg2Pa1vXJzqI/nDi', 'client', 'active', '2025-04-22 22:13:23', 0, 'female', 18);
...
ALTER TABLE `reservation_services`
  ...
  ADD CONSTRAINT `reservation_services_ibfk_2` FOREIGN KEY (`service_id`) REFERENCES `extra_options` (`id`);
